...
public class PzshAdapter extends RecyclerView.Adapter<PzshAdapter.MyViewHolder> {
    Context context;
    List<HomeDataEntity.ResultBean.PzshBean.CommodityListBeanX> commodityList;
    public PzshAdapter(Context context, List<HomeDataEntity.ResultBean.PzshBean.CommodityListBeanX> commodityList) {
