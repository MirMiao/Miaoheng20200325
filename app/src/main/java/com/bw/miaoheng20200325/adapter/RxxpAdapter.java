...
import com.bw.miaoheng20200325.view.Main2Activity;
...
public class RxxpAdapter extends RecyclerView.Adapter<RxxpAdapter.MyViewHolder> {
    Context context;
    List<HomeDataEntity.ResultBean.RxxpBean.CommodityListBean> commodityList;
    public RxxpAdapter(Context context, List<HomeDataEntity.ResultBean.RxxpBean.CommodityListBean> commodityList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.rxxp_item_layout, null);
